# Classification Guidelines: Modified Starches
...
This document provides classification guidelines for modified starches products
as they relate to tariff codes, regulatory requirements, and internal categorization.

## Regulatory Background

Products in the modified starches category are subject to various regulatory
...
|----------------|--------------|------------|-------|
| Rapeseed Oil | LEGACY_SIGMA | SIG-53-AHT-MGFX | Verified |
| Rapeseed Oil | ERP_GAMMA | RA-OI-258 | Verified |
| Rapeseed Oil | ERP_DELTA | rapeseed oil | Verified |
| Dextrose Food Grade | LEGACY_SIGMA | SIG-26-DML-NZS4 | Verified |
| Dextrose Food Grade | ERP_BETA | Traubenzucker Lebensmittelrein | Verified |
