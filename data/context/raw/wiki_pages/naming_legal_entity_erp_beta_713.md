# Legal Entity Naming Conventions: ERP_BETA
...
legal entity entities in the ERP_BETA system.
...
- **Rotterdam Plant**: Internal codes with `RTM` prefix
  are assigned to NL regional targets

- **Sao Paulo Plant (acquired 2022-06-01)**: Internal codes with `SAO` prefix
  are assigned to BR regional targets
