# Tax Code Naming Conventions: ERP_BETA

> **Warning:** Some information on this page may no longer be accurate
> **Owner:** Data Governance Team

## Overview

This page documents the naming conventions used for tax code entities
in the ERP_BETA system. Understanding these conventions is critical for proper
entity matching and data integration.

## Historical Context

Prior to the 2023 system consolidation, tax code records existed in
...
2. **Missing Attributes**: Approximately 9% of records
...
|--------|---------|--------|--------|
| Completeness | 89% | 95% | Warning |
| Accuracy | 95% | 99% | Review Needed |
| Consistency | 83% | 95% | Improving |
